    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buglevel', models.CharField(choices=[('1', '1'), ('2', '2'), ('3', '3'), ('4', '4')], default='3', max_length=200, null=True, verbose_name='严重程度')),
                ('bugcreater', models.CharField(max_length=200, verbose_name='创建人')),
                ('bugassign', models.CharField(max_length=200, verbose_name='指派给')),
